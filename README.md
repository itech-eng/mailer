...
Mailer is using [Render](github.com/itech-eng/render) to render email templates and layouts, please refer it for How-To.
...
```go
import "github.com/itech-eng/assetfs"
